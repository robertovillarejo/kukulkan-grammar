...
public class KukulkanFactoryImpl extends EFactoryImpl implements KukulkanFactory
{
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case KukulkanPackage.ENTITY_TYPE: return createentityType();
      ...
      case KukulkanPackage.MAX_BYTES_VALIDATOR: return createmaxBytesValidator();
      case KukulkanPackage.OPTION: return createoption();
      default:
