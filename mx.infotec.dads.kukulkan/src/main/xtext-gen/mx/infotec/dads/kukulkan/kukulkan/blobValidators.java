...
public interface blobValidators extends EObject
{
  ...
  /**
   * Returns the value of the '<em><b>Max Bytes Value</b></em>' containment reference.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Max Bytes Value</em>' containment reference isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Max Bytes Value</em>' containment reference.
   * @see #setMaxBytesValue(maxBytesValidator)
   * @see mx.infotec.dads.kukulkan.kukulkan.KukulkanPackage#getblobValidators_MaxBytesValue()
   * @model containment="true"
   * @generated
   */
  maxBytesValidator getMaxBytesValue();

  /**
   * Sets the value of the '{@link mx.infotec.dads.kukulkan.kukulkan.blobValidators#getMaxBytesValue <em>Max Bytes Value</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Max Bytes Value</em>' containment reference.
   * @see #getMaxBytesValue()
   * @generated
   */
  void setMaxBytesValue(maxBytesValidator value);
