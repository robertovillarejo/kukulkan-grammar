		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getPATTERN_VALUEAccess().getGroup(), "rule__PATTERN_VALUE__Group__0");
					put(grammarAccess.getDomainModelAccess().getEntitiesAssignment_0(), "rule__DomainModel__EntitiesAssignment_0");
					put(grammarAccess.getDomainModelAccess().getSettingsAssignment_1(), "rule__DomainModel__SettingsAssignment_1");
					...
					put(grammarAccess.getEntityFieldAccess().getIdAssignment_0(), "rule__EntityField__IdAssignment_0");
					put(grammarAccess.getEntityFieldAccess().getTypeAssignment_1(), "rule__EntityField__TypeAssignment_1");
					...
					put(grammarAccess.getOptionAccess().getSettingAssignment(), "rule__Option__SettingAssignment");
				}
			};
		}
